...
%MSBUILD_VS2010% src\SharpSvn.sln/p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v90
@IF ERRORLEVEL 1 EXIT /B %ERRORLEVEL%

%MSBUILD_VS2010% v40\src\SharpSvn.sln/p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v100
@IF ERRORLEVEL 1 EXIT /B %ERRORLEVEL%
